...
const JobCard: React.FC<JobCardProps> = ({ job }) => {
  ...
  // Function to get a random gradient for the company logo background
  ...
  // Calculate the match color based on score
  ...
  return (
    <div className="bg-dark-400 rounded-xl overflow-hidden shadow-lg border border-dark-600 hover:border-primary-500/50 transition-all duration-300 transform hover:-translate-y-1">
      ...
      <div className="flex justify-between items-center p-4 border-b border-dark-600">
        <div className="flex items-center space-x-3">
          <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${getRandomGradient()} flex items-center justify-center text-white font-bold text-lg shadow-md`}>
        ...
        <div>
          <span className={`px-3 py-2 rounded-full font-medium ${getMatchColor(job.matching_score)}`}>
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          {job.skills_matched && job.skills_matched.length > 0 && (
            <div>
              <h4 className="text-sm uppercase tracking-wider text-foreground/60 mb-2 font-medium flex items-center">
      ...
      <div className="bg-dark-800/50 p-4 flex justify-between items-center">
        ...
        <button className="bg-gradient-to-r from-indigo-400 to-purple-500 hover:from-indigo-500 hover:to-purple-600 text-white px-4 py-2 rounded-lg transition-all duration-200 flex items-center shadow-md">
          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
