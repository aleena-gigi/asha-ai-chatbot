    ...
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden py-20 sm:py-32">
        ...
        <div className="container relative mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center">
          <div className={`md:w-1/2 mb-12 md:mb-0 transition-all duration-1000 translate-x-0 opacity-100`}>
          ...
          <div className={`md:w-1/2 flex justify-center transition-all duration-1000 delay-300 translate-x-0 opacity-100`}>
