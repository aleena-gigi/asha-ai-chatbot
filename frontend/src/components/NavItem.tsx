      ...
      <Link
        ...
        className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium transition-colors duration-300 ${
          isActive 
            ...
            : 'border-transparent text-foreground/70 hover:bg-dark-600 hover:border-primary-500/40 hover:text-foreground'
        }`}
      >
    ...
    <Link
      ...
      className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition-all duration-300 ${
        isActive 
          ...
          : 'border-transparent text-foreground/70 hover:border-primary-500/40 hover:text-foreground'
      }`}
    >
